...
//		return [
//		  $.jcoverflip.animationElement( el, { left: -(637 + 150)*(offset+1) +'px', bottom: '0',opacity:0.6,width:637,height:380 }, { } ),
//		  $.jcoverflip.animationElement( el.find( 'img' ), { width:637,height:380 }, {} )
//		];
//	  },
//	  afterCss: function( el, container, offset ){
//		return [
//		  $.jcoverflip.animationElement( el, { left: (637 + 150)*(offset+1)+'px', bottom: '0',width:637,height:380,opacity:0.6 }, { } ),
//		  $.jcoverflip.animationElement( el.find( 'img' ), { width:637,height:380 }, {} )
//		];
//	  },
//	  currentCss: function( el, container ){
//		return [
//		  $.jcoverflip.animationElement( el, { left: 0+'px', bottom: 0,opacity:1,width:637,height:380 }, { } ),
//		  $.jcoverflip.animationElement( el.find( 'img' ), { width:637,height:380 }, { } ),
//		  $.jcoverflip.animationElement( el.find( 'a' ), { display:'block',width:637,height:380}, { } )
//		];
//	  },
//	  change: function(event, ui){
//		  $('#section1_1 .pager a').removeClass('active');
//		  $('#section1_1 .pager a').eq(ui.to).addClass('active');
//		  $('#flip li a').css('display','none'); 
//		  $('#flip li').eq(ui.to).find('a').css('display','block');
//	  }
//	});
	if($('#flip').length>0)
	{
...
//			}
	...
	$('.photowall_category_icons a').click(function(){
