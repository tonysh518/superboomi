        ...
        <section class="section_box" id="section_1">
            ...
            <section id="photowall">
                ...
                <div class="photowall_right">
                    ...
                    <div class="clear"></div>
                    <div id="photowall_text"><span><?php print t('Welcome to our BOOMi photo wall! We\'re continuing to improve the design and add more fun features. Our first BOOMi Photo Fun contest will be taking place in February 2013 so check back here soon for details!')?></span></div>
