...
<div class="toppick_comment">
	<?php print $fields['field_top_picked_comments']->content;?>
</div>
<img id="toppick_bg" src="<?php print $base_path;?>themes/bartik/images/toppicked_bg.gif" />